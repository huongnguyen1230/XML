...
<!-- Description: Stylesheet file to transform the XML document -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/PurchaseOrder">
        ...
        <xsl:apply-templates select="DeliverDate"/>
    ...
    <xsl:template match="PONumber">
        <h1 align="center">David Enterprises......</h1>
    ...
    <xsl:template match="DeliverDate">
        Delivery Date:
        <xsl:value-of select="."/>
        <br/>
    </xsl:template>
